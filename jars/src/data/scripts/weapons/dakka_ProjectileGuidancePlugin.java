...
public class dakka_ProjectileGuidancePlugin extends BaseEveryFrameCombatPlugin {
     ...
     */
    public dakka_ProjectileGuidancePlugin(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        //Otherwise, we start our guidance stuff...
            ...
            float actualTurnRate = TURN_RATE * proj.getVelocity().length();

...
public class CryoblasterEffect extends BaseCombatLayeredRenderingPlugin implements OnFireEffectPlugin,
	...
	public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
		...
		// dakka vfx
		Color flashCol = projectile.getProjectileSpec().getFringeColor();
		engine.spawnExplosion(projectile.getLocation(), weapon.getShip().getVelocity(), flashCol, 60f, 0.15f);
		engine.addNebulaParticle(projectile.getLocation(),weapon.getShip().getVelocity(),50f,1.5f, 0.1f,0.2f,1f,flashCol);
